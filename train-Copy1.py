...
# 두 generator를 동시에 optimizer에 넣어줌
import itertools
    ...
    if mode == 'train':
        ...
        for epoch in range(st_epoch + 1, num_epoch + 1):
            ...
            if epoch % 2 == 0 or epoch == num_epoch:
                save(ckpt_dir=ckpt_dir, netG_a2b=netG_a2b, netG_b2a=netG_b2a, netD_a=netD_a,
                     netD_b=netD_b, optimG=optimG, optimD=optimD, epoch=epoch)
...
def test(args):
    ...
    if mode == "test":
        ...
        optimG, optimD, st_epoch = load(ckpt_dir=ckpt_dir, netG_a2b=netG_a2b, netG_b2a=netG_b2a,
                                        netD_a=netD_a, netD_b=netD_b, optimG=optimG, optimD=optimD)
